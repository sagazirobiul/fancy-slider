...
const durationCheck = document.getElementById('duration').value || 1000;
if (sliders.length < 2 || durationCheck < 1000) {
  if (sliders.length < 2) {
...
const showErrorMessage = () => {
  document.getElementById('errorMessage').innerText = 'Sorry.!!! I failed to load an image, Please try again :)';
  toggleSpinner();
}
